...
{
    UIActionSheet *sheet = [[UIActionSheet alloc] initWithTitle:@"Attach Receipt" delegate:self cancelButtonTitle:@"No Receipt Available" destructiveButtonTitle:nil otherButtonTitles:@"Pick from library",@"Take new picture", nil];
