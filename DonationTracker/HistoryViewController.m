...
-(void) performReceiptViewSegue:(UIStoryboardSegue *) segue
{
    ...
    ReceiptViewController *receiptViewController = (ReceiptViewController *) segue.destinationViewController;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSDictionary *helveticaLightAttr = @{NSFontAttributeName:[UIFont fontWithName:@"HelveticaNeue-Light" size:14]};
